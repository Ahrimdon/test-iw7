...
!ifdef MUI_WELCOMEPAGE
  ...
  ${LangFileString} MUI_TEXT_WELCOME_INFO_TEXT "Setup will guide you through the installation of the $(^NameDA) Client for Call of Duty Infinite Warfare.$\r$\n$\r$\nIt is recommended that you close all other applications before installing.$\r$\n$\r$\nYou will not need to restart your computer after installation.$\r$\n$\r$\n$_CLICK"
!endif
...
!ifdef MUI_DIRECTORYPAGE
  ...
  ${LangFileString} MUI_TEXT_DIRECTORY_SUBTITLE "Choose your Call of Duty Infinite Warfare game folder in which to install $(^NameDA)."
!endif
